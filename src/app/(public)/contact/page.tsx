...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl flex mx-auto items-center min-h-screen  ">
      <div className="text-start items-center justify-center w-full mt-7 sm:mt-0 p-2 sm:p-0">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className=" space-y-2 md:space-y-3">
              ...
              <div>
                ...
                <select
                  {...register("reason", { required: "Full name is required" })}
